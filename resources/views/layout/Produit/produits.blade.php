    ...
    <div class="border-2 rounded-lg shadow-lg bg-white">
        ...
        <div class="relative  shadow-md  p-3  ">
            ...
            <div class="w-full flex items-center justify-between p-3 mb-5">
                ...
                <div>
                    <a href="{{ url('produits\create') }}">
                        <button
                            class="inline-flex items-center text-gray-100 bg-green-700 focus:ring-4 font-medium rounded-lg md:text-sm md:py-3 md:px-2 md:w-44 w-24 text-xs py-2 px-1 "
                            type="button">
                        ...
                        @foreach ($produits as $item)
                            ...
                            @endif
                                ...
                                <td class="px-6 py-3 flex items-center ">
                                    <a href=" {{ url('/produits/' . $item->id_produit) }} " title="View P">
                                        <button type="button"
